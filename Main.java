...
public class Main {
	...
	public static void main(String[] args) {
	  ...
	  Personne x=new Personne ("titi", "titi","titi","Paris","F",new Date("31/08/2000"));
	  Personne y=new Personne("momo","momo","mm","Paris","M",new Date("12/12/2012"));
	  Personne z=new Personne ("yooo", "yooo","yooo","Paris","F",new Date("12/12/2222"));
	  Personne a =new Personne("tata","toto","toto","ici","M",new Date("01/05/2000"));
	  Personne b =new Personne ("polo","polo","pp","paname","M",new Date("11/11/2011"));
	   registre.ajouterPersonne (x);
	   registre.ajouterPersonne(y);
	   registre.ajouterPersonne(z);
	  ...
	  int reponse=clav.nextInt();
	   ...
	   if(reponse==1) {
		    ...
		    System.out.println("saisir le nom : ");
		  	...
		  	Personne s=new Personne(nom, nomUsage, prenom,lieuNaissance, sexe, dateNaissance);	
		  	
		    registre.ajouterPersonne(s);
		   ...
		   Personne x = registre.trouverPersonne(0);
		   if (x==null) {
...
public static void Mariage(){
	Personne x = registre.trouverPersonne(0);
	Personne y = registre.trouverPersonne(1);
